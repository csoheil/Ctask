...
<section class="hero">
    ...
    <p>We do your tasks with the best quality & lowest price(80 to 99 % Lower than hiring a freelance)</p>
...
<section class="services-preview">
    ...
    <div class="services-container">
        ...
        <div class="card">
            ...
            <p>Professional academic & technical research.</p>
        </div>
        ...
        <div class="card">
            <h3>Industrial Design (CATIA)</h3>
            <p>3D modeling & industrial product design.</p>
        </div>
